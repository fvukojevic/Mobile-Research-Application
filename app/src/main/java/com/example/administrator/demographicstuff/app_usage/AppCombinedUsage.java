...
public class AppCombinedUsage extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_app_combined_usage);
    ...
    private void initializeRecyclerViewProperties() {
        ...
        adapter.usageList = new NetworkUsageHelper(getApplicationContext()).getTotalUsageList();
        ...
        appOps.startWatchingMode(AppOpsManager.OPSTR_GET_USAGE_STATS,
                ...
                new AppOpsManager.OnOpChangedListener() {
                    ...
                    public void onOpChanged(String op, String packageName) {
                        ...
                        Intent intent = new Intent(AppCombinedUsage.this, AppCombinedUsage.class);
